...
CREATE UNIQUE INDEX IF NOT EXISTS idx_prompt_templates_single_active_per_client
  ON prompt_templates (cliente_id, is_active)
...
INSERT INTO prompt_templates (cliente_id, version, label, body, is_active) VALUES (
